...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->normalizedIds = array(
            ...
            'wt_galerieitem.fixture' => 'wt_galerieItem.fixture',
        );
        ...
        $this->fileMap = array(
            ...
            'wt_galerie.antispam' => __DIR__.'/getWtGalerie_AntispamService.php',
            'wt_galerie.fixture' => __DIR__.'/getWtGalerie_FixtureService.php',
            'wt_galerieItem.fixture' => __DIR__.'/getWtGalerieItem_FixtureService.php',
            'wt_user.fixture' => __DIR__.'/getWtUser_FixtureService.php',
        );
        $this->privates = array(
            ...
            'wt_galerie.antispam' => true,
            'wt_galerie.fixture' => true,
            'wt_galerieItem.fixture' => true,
            'wt_user.fixture' => true,
        );
        $this->aliases = array(
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('V3xi65XhuI', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SznQrAQYch', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jYDwdlLlak', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4l01AIhxTp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8tq371ut4S', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/WT/GalerieBundle/Resources/views'), 'WTGalerie');
        $instance->addPath(($this->targetDirs[3].'/src/WT/GalerieBundle/Resources/views'), '!WTGalerie');
        $instance->addPath(($this->targetDirs[3].'/src/WT/UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/WT/UserBundle/Resources/views'), 'WTUser');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WTGalerieBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/WT/GalerieBundle'),
                    'namespace' => 'WT\\GalerieBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
                ...
                'WTUserBundle' => array(
                    ...
                    'path' => ($this->targetDirs[3].'/src/WT/UserBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WTGalerieBundle' => 'WT\\GalerieBundle\\WTGalerieBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'WTUserBundle' => 'WT\\UserBundle\\WTUserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'whitetheo',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'white.theo.j@gmail.com',
            'mailer_user' => 'white.theo.j@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'white.theo.j@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'white.theo.j@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Mail_pass',
            ...
            'fos_user.model.user.class' => 'WT\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'white.theo.j@gmail.com' => 'white.theo.j@gmail.com',
            ),
